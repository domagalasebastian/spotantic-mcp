...
async def get_user_top_tracks_tool(
    ...
    Returns:
        A paged result containing simplified track objects for the user's top tracks.
    ...
    return PagedResultView[TrackView].model_validate(api_data)
