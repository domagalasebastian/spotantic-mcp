...
async def get_user_saved_tracks_tool(
    ...
    Returns:
        A paged result containing saved track objects for the tracks in the user's library.
    ...
    return PagedResultView[SavedTrackView].model_validate(api_data)
