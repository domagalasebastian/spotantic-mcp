...
async def pause_playback_tool(ctx: Context[ServerSession, AppContext], *, device_id: str | None = None) -> str:
    ...
    await pause_playback(spotantic_client, device_id=device_id)
    return "Successfully paused playback on the user's account."
